...
public class ClaimFailureIdempotencyHandler {
     ...
     *                             {@code FAIL_OPEN}
     * @throws exception.RequestNotCompletedException nếu một request khác cùng key đang
     *                                       xử lý (propagate từ {@code inner})
     * @throws exception.IdempotencyConflictException nếu payload khác với lần gọi trước
